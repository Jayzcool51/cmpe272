<?php
    ...
    $ratings = mysqli_query($conn,"SELECT * from `Rating` r LEFT JOIN `User` u ON u.user_id = r.user_id 
    INNER JOIN `Product` p ON r.product_id = p.product_id WHERE r.product_id = '$search_id'");
    $data = array();
